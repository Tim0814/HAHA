...
public class extend {
	...
	public static void displayArea(Shape obj) {    
	    System.out.printf("%.2f", obj.getArea()); //這裡面的方法必須是父類別跟子類別都有的方法
	}
	
	public static void displayPerimeter(Shape obj) {    
	    System.out.printf("%.2f", obj.getPerimeter()); //這裡面的方法必須是父類別跟子類別都有的方法
	}
    ...
    class Shape {    
   	 ...
   	 //constructor
		 ...
		 //要先在父類別設置getArea()跟getPerimeter()，不然沒辦法使用displayArea()跟displayPerimeter()，因為它的範圍是Shape裡的所有資料型態跟方法
	   }
